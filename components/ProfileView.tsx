  ...
  return (
    <div className="max-w-4xl mx-auto pb-10">
      <div className="flex items-center gap-3 mb-6">
        {onBack && (
          <button onClick={onBack} className="p-2 hover:bg-gray-200 rounded-full transition-colors" aria-label="Voltar">
            <ArrowLeft size={24} className="text-gray-600" />
          </button>
        )}
        <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
          <UserIcon className="text-blue-600" /> 
          {onBack ? `Editando: ${currentUser.name}` : 'Meu Perfil'}
        </h2>
      </div>
        ...
        <div className="px-8 pb-8">
          ...
          <div className="relative -mt-16 mb-6 flex flex-col items-center sm:items-start">
            <div className="relative group">
              ...
              <label 
                htmlFor={fileInputId}
                className="absolute bottom-1 right-1 bg-blue-600 text-white p-2 rounded-full shadow-lg border-2 border-white sm:hidden cursor-pointer active:scale-90 transition-transform"
              >
                <Camera size={18} />
              </label>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 bg-white shadow-sm" 
                  />
                </div>
              </div>
              ...
              <div className="col-span-1 md:col-span-2 bg-gray-50 p-5 rounded-xl border border-gray-200 mt-2">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="col-span-1">
                      ...
                      <div className="relative">
                        <input 
                          className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 bg-white text-sm shadow-sm"
                          value={cep}
                        ...
                        />
                        {isLoadingCep ? (
                          <div className="absolute right-3 top-3 animate-spin"><Loader2 size={16} className="text-blue-500"/></div>
                        ) : (
              ...
              <div className="col-span-1 md:col-span-2 space-y-1">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider flex justify-between">
                  Link da Foto (URL)
                  {avatarUrl.startsWith('data:') && <span className="text-blue-600">Arquivo local selecionado</span>}
                </label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 bg-white text-sm shadow-sm" 
                  />
                </div>
              </div>
            ...
            <div className="pt-6 border-t flex flex-col sm:flex-row justify-end gap-3">
               {onBack && (
                  <button 
                    type="button"
                    onClick={onBack}
                    className="px-6 py-3 border border-gray-300 text-gray-600 font-bold rounded-lg hover:bg-gray-50 transition-colors"
                  >
                    Cancelar
                  </button>
               )}
              <button 
                ...
                className="flex items-center justify-center gap-2 px-8 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-all shadow-lg shadow-blue-200"
              >
                {isProcessingImage ? <Loader2 className="animate-spin"/> : <Save size={20} />}
                Salvar Alterações
              </button>
            </div>
          </form>
